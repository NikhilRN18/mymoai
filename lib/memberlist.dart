              ...
              itemBuilder: (context, index) {
                if (index == 0) {
                  ...
                  return Card(
                    ...
                    child: ListTile(
                      title: Text('Member ${index}', style: TextStyle(fontSize: 24, color: Colors.white)), // This sets the font size of the text to 24 and the color to white
                      subtitle: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          Text('Contact Information:', style: TextStyle(color: Colors.white)), // This is a placeholder for the contact information
                          Text('Other Stuff:', style: TextStyle(color: Colors.white)), // This is a placeholder for the other stuff
                        ],
                      ),
                    ),
                  );
